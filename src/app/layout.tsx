...
export const metadata: Metadata = {
  title: "Artisan Bakery | Handcrafted Breads & Pastries",  description: "Discover authentic handcrafted breads, pastries, and desserts baked fresh daily using premium natural ingredients and time-honored techniques.",  keywords: "bakery, artisan bread, pastries, sourdough, croissants, fresh baked goods, local bakery",  openGraph: {
    title: "Artisan Bakery | Handcrafted Breads & Pastries",    description: "Experience the warmth of true artisanal baking with our premium selection of breads and pastries.",    siteName: "Artisan Bakery",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/assortment-bread-products_123827-36235.jpg",        alt: "Artisan Bakery - Fresh Baked Goods"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Artisan Bakery | Handcrafted Breads & Pastries",    description: "Discover authentic handcrafted breads, pastries, and desserts baked fresh daily.",    images: ["http://img.b2bpic.net/free-photo/assortment-bread-products_123827-36235.jpg"]
  },
  robots: {
    index: true,
    follow: true
